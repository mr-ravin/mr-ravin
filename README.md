...
- 🎮 <i><b>Indie-Game Developer</b></i>: 
  - [x] [RotationWars](https://github.com/mr-ravin/rotationwars): An opensource minimalistic multiplayer video game developed with the **Unity3D** game engine for android, where players compete on a rotating platform. They can push each other and maneuver to avoid being pushed off. The goal is to make opponents fall off the platform to claim victory.
  ...
  - [x] [Blocks-N-Head](https://github.com/mr-ravin/blocks-n-head): An opensource minimalistic video game built with **GoDot Game Engine**, where the objective is to help the character avoid falling blocks.
